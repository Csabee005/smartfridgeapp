package com.kmooc.smartfridgeapp.com.szak.util.animation.listview;
...
public class AnimatedListView extends ExpandableListView {
        /*
        ...
        public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
            ...
            private AnimatedListView parent;

            private static final int STATE_IDLE = 0;
            private static final int STATE_EXPANDING = 1;
            private static final int STATE_COLLAPSING = 2;

            private void setParent(AnimatedListView parent) {
                this.parent = parent;
            }
            ...
            public final View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, final ViewGroup parent) {
                ...
                if (info.animating) {
                    ...
                    final AnimatedListView listView = (AnimatedListView) parent;
